...
@if($license)
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <p>Yang bertanda tangan di bawah ini, Kami pengurus Pondok Pesantren Miftahul Ulum Kebun baru
                    menerangkan bahwa anak tersebut di bawah ini:</p>
            </div>
            <div class="col-12">
                <table class="table mb-0" border="0">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $license->petition->student->place_of_birth }}
                            , {{ $license->petition->student->date_of_birth->isoFormat('D MMMM Y') }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            P2K, {{ $license->petition->registration->domicile }}
                            - {{ $license->petition->registration->domicile_number }}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            {{ $license->petition->registration->grade_of_diniyah }}
                            – {{ $license->petition->registration->diniyah->shortname }}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            {{ $license->petition->registration->grade_of_formal }}
                            – {{ $license->petition->registration->formal->shortname }}
                        </td>
                    </tr>
                    <tr>
                        <td class="pl-5">
        ...
        <div class="col-12">
            <p>
                Telah diberi izin untuk pulang/bepergian selama <b>{{ $license->start_at->diff($license->end_at) }}</b>,
                berlaku sejak tanggal ditetapkan
                dan harus kembali ke pondok pesantren selambat-lambatnya :
                <br> {{ $license->end_at->isoFormat('dddd, DD MMMM YYYY') }} pukul
                <b>{{ $license->end_at->isoFormat('HH:mm') }}</b>.
            </p>
        </div>
        <div class="col-12">
        ...
        <div class="row">
            <div class="col-12">
                <table class="table" style="margin-bottom: 8px">
                    <tr>
                        <td style="text-align: end">Kebun baru, {{ hijriToString($license->start_at_hijri) }}
                            / {{ dateToString($license->start_at->format('Y-m-d')) }}</td>
                    </tr>
                </table>
            </div>
        </div>
